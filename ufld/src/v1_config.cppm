...
IConfig::IConfig(uint32_t row_anchor_cell_count, std::vector<uint32_t> row_anchors)
...
struct CULaneConfig : public IConfig {
  CULaneConfig()
      : IConfig{200 + 1, {121, 131, 141, 150, 160, 170, 180, 189, 199, 209, 219, 228, 238, 248, 258, 267, 277, 287}} {}
};

struct TuSimpleConfig : public IConfig {
  TuSimpleConfig()
      : IConfig{100 + 1, {64,  68,  72,  76,  80,  84,  88,  92,  96,  100, 104, 108, 112, 116, 120, 124, 128, 132, 136,
