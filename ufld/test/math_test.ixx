...
TEST(UfldMath, SoftMax) {
  {  // 2D (1D)
    ...
    const xt::xarray<float> expected{{0.00626879f, 0.01704033f, 0.04632042f, 0.93037047f}};
  ...
  {  // 2D
    const xt::xarray<float> a{{1.0f, 2.0f, 3.0f, 6.0f}, {2.0f, 4.0f, 5.0f, 6.0f}, {1.0f, 2.0f, 3.0f, 6.0f}};
